...
tags:
  ...
  - Microsoft365
private: false
updated_at: '2026-04-10T20:29:01+09:00'
id: 65eb2aba34d2ea99d738
...
https://qiita.com/su3-hokkaido/items/98ce34986289e1449b66
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/2819748/8fe469f3-b449-4ef7-9357-51d4a366446d.png)

Connectors の Edit ボタンをクリックします。

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/2819748/11b02ccf-52a4-4b3b-9ffa-13d4f3874a12.png)

Incoming Webhook を追加します。

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/2819748/e7238ee7-3e2c-4beb-b247-8ef112fe5ccf.png)

ポチポチ設定を進めていくと、通知アプリの名称、アイコンを設定する画面が出てくるので、こちらで任意の名称、アイコンを設定しましょう。
最後に Webhook URL が発行されるので、それをクリップボードにコピーなりで控えてください。

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/2819748/f464e0ba-ce2d-4825-9275-8ce2c8ca03fc.png)
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/2819748/ac8f7722-9c60-42bd-9cab-24a4c5cd91e2.png)
